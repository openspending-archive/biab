...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'DataPackage', fields ['slug']
        db.delete_unique(u'bdpsite_datapackage', ['slug'])


        # Changing field 'DataPackage.slug'
        db.alter_column(u'bdpsite_datapackage', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique_with=['project__slug'], max_length=50, populate_from='title'))

        # Changing field 'Project.slug'
        db.alter_column(u'bdpsite_project', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique=True, max_length=50, populate_from='title', unique_with=()))

    def backwards(self, orm):

        # Changing field 'DataPackage.slug'
        db.alter_column(u'bdpsite_datapackage', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, unique=True))
        # Adding unique constraint on 'DataPackage', fields ['slug']
        db.create_unique(u'bdpsite_datapackage', ['slug'])


        # Changing field 'Project.slug'
        db.alter_column(u'bdpsite_project', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, unique=True))
    ...
    models = {
        ...
        u'bdpsite.datapackage': {
            ...
            'slug': ('autoslug.fields.AutoSlugField', [], {'unique_with': "['project__slug']", 'max_length': '50', 'populate_from': "'title'"})
        },
        u'bdpsite.dataset': {
            'Meta': {'object_name': 'Dataset'},
            'currency': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'datamodel': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256'}),
            'openspending': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True'}),
            'path': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'}),
            'preprocessed': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['bdpsite.Project']"}),
