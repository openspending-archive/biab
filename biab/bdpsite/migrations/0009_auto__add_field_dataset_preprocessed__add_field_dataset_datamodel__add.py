...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Dataset.preprocessed'
        db.add_column(u'bdpsite_dataset', 'preprocessed',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True),
                      keep_default=False)

        # Adding field 'Dataset.datamodel'
        db.add_column(u'bdpsite_dataset', 'datamodel',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True),
                      keep_default=False)

        # Adding field 'Dataset.openspending'
        db.add_column(u'bdpsite_dataset', 'openspending',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Dataset.preprocessed'
        db.delete_column(u'bdpsite_dataset', 'preprocessed')

        # Deleting field 'Dataset.datamodel'
        db.delete_column(u'bdpsite_dataset', 'datamodel')

        # Deleting field 'Dataset.openspending'
        db.delete_column(u'bdpsite_dataset', 'openspending')
