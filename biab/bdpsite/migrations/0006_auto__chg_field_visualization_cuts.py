...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Visualization.cuts'
        db.alter_column(u'bdpsite_visualization', 'cuts', self.gf('django.db.models.fields.CharField')(max_length=512, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Visualization.cuts'
        raise RuntimeError("Cannot reverse this migration. 'Visualization.cuts' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Visualization.cuts'
        db.alter_column(u'bdpsite_visualization', 'cuts', self.gf('django.db.models.fields.CharField')(max_length=512))
