...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.featured_viz'
        db.add_column(u'bdpsite_project', 'featured_viz',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bdpsite.Visualization'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.featured_viz'
        db.delete_column(u'bdpsite_project', 'featured_viz_id')
