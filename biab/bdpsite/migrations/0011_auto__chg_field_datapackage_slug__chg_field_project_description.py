...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'bdpsite_datapackage', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique_with=('project__slug',), max_length=50, populate_from='name'))

        # Changing field 'Project.description'
        db.alter_column(u'bdpsite_project', 'description', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'DataPackage.slug'
        db.alter_column(u'bdpsite_datapackage', 'slug', self.gf('autoslug.fields.AutoSlugField')(max_length=50, unique_with=['project__slug'], populate_from='title'))

        # Changing field 'Project.description'
        db.alter_column(u'bdpsite_project', 'description', self.gf('django.db.models.fields.TextField')(null=True))
