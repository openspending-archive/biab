...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Visualization.order'
        db.add_column(u'bdpsite_visualization', 'order',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Visualization.drilldowns'
        db.add_column(u'bdpsite_visualization', 'drilldowns',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=512),
                      keep_default=False)

        # Adding field 'Visualization.cuts'
        db.add_column(u'bdpsite_visualization', 'cuts',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=512),
                      keep_default=False)

        # Adding field 'Visualization.type'
        db.add_column(u'bdpsite_visualization', 'type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Visualization.order'
        db.delete_column(u'bdpsite_visualization', 'order')

        # Deleting field 'Visualization.drilldowns'
        db.delete_column(u'bdpsite_visualization', 'drilldowns')

        # Deleting field 'Visualization.cuts'
        db.delete_column(u'bdpsite_visualization', 'cuts')

        # Deleting field 'Visualization.type'
        db.delete_column(u'bdpsite_visualization', 'type')
    ...
    models = {
        ...
        u'bdpsite.visualization': {
            ...
            'cuts': ('django.db.models.fields.CharField', [], {'max_length': '512'}),
