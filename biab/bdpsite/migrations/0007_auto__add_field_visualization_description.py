...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Visualization.description'
        db.add_column(u'bdpsite_visualization', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Visualization.description'
        db.delete_column(u'bdpsite_visualization', 'description')
