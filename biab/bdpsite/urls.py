...
urlpatterns = patterns('',
    ...
    url(r'^(?P<project>[-\w]+)/packages/delete/(?P<id>\d+)/$',
...
#        'bdpsite.views.addpackage'),
    ...
    url(r'^(?P<project>[-\w]+)/datasets/preprocess/(?P<id>\d+)/$',
        'bdpsite.views.preprocessdataset'),
    url(r'^(?P<project>[-\w]+)/datasets/model/(?P<id>\d+)/$',
        'bdpsite.views.generatemodel'),
    url(r'^(?P<project>[-\w]+)/datasets/os-upload/(?P<id>\d+)/$',
